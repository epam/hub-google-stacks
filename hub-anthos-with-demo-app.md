...
Please explore `parameters` section of the [`hub-anthos-with-demo-app.yaml`](https://github.com/agilestacks/google-stacks/blob/main/hub-anthos-with-demo-app-cs.yaml) to see what parameters are available.
